...
export function ZoneIcon({ type, color, size = 52 }: { type: string; color: string; size?: number }) {
  ...
  /* Shared stroke props — no fill here so it never conflicts with explicit fill overrides */
  const s = {
    stroke: color,
    strokeWidth: sw,
  ...
  switch (type) {
    ...
    case 'step':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24">
          <path d="M2 20h4v-4h4v-4h4v-4h4v-4h4" fill="none" {...s} />
        </svg>
      );
    ...
    case 'switch':
      return (
        <svg width={size} height={size} viewBox="0 0 24 24">
          <path d="M18.36 6.64a9 9 0 11-12.73 0" fill="none" {...s} />
          <line x1="12" y1="2" x2="12" y2="12" fill="none" {...s} />
        </svg>
      );
      ...
      return (
        <svg width={size} height={size} viewBox="0 0 24 24">
          <path
            ...
            fill={color} fillOpacity={0.22} {...s}
          />
          <line x1="12" y1="9" x2="12" y2="13" fill="none" {...s} />
      ...
      return (
        <svg width={size} height={size} viewBox="0 0 24 24">
          <path
            ...
            fill={color} fillOpacity={0.22} {...s}
          />
          <line x1="9" y1="17" x2="15" y2="17" fill="none" {...s} />
        </svg>
      );
  }
}
